...
class Login_page(object):
    ...
    def process_request(self, request, spider):
        ...
        if spider.name == 'scjrm_zszq':
            ...
            spider.driver = webdriver.Chrome(chrome_options=chrome_options,executable_path="C:/Users/Administrator/AppData/Local/Google/Chrome/Application/chromedriver.exe")
            ...
            time.sleep(3)
            spider.driver.find_element_by_link_text('诊所专区').click()
        ...
        elif spider.name == 'scjuchuang_yxzq':
            # 判断是否是登陆
            # if request.url.find('login') != -1:
            spider.driver = webdriver.Chrome(chrome_options=chrome_options,executable_path="C:/Users/Administrator/AppData/Local/Google/Chrome/Application/chromedriver.exe")
