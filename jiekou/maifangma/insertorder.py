...
if __name__=='__main__':
    ...
    insertorder_data="version=1.0.0&deviceNo=72465872a0ff482784a8985615792f4f&deviceType=2&cityId=51010000"
    ...
    print signature2
    #strencrypt2= encrypt.encrypt("{\"housesId\":\"753462205638246400\",\"phone\":\"18008062016\",\"sex\":\"0\",\"orderDate\":\"%f\",\"orderUserName\":\"qu\",\"housekeeperId\":\"771241268746387456\"}"%time.time(),deskey)
    insertorder_data2={"sign":signature2,
                       ...
                       "housesId":"753462205638246400",
                       "phone":"18008062016",
                       "sex":"0",
                       "orderDate":time.time(),
                       "orderUserName":"qu",
                       "housekeeperId":"771241268746387456"
